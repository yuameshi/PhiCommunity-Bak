import './style.css';
import AppIcon_svg from 'assets/images/AppIcon.svg';
import { settings } from './setting.js';
import { SliderItem, ToggleItem, ButtonItem } from './components/index.js';

const appIconElem = document.createElement('img');
appIconElem.alt = 'app_icon';
appIconElem.src = AppIcon_svg;
document.getElementsByClassName('appIcon')[0].prepend(appIconElem);
